...
use App\Http\Controllers\PendudukController;    // <-- Controller Penduduk
use App\Http\Controllers\AntrianSuratController; // <-- Controller Antrian Surat BARU/DIPASTIKAN
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    // RESOURCE ROUTES (Penduduk & Antrian Surat)
    Route::resource('penduduk', PendudukController::class);
    // Rute yang diminta: Route::resource('/antrian-surat', AntrianSuratController::class);
    // Menggantikan Route::resource('antrian', AntrianSuratController::class); yang lama:
    Route::resource('antrian-surat', AntrianSuratController::class); 
