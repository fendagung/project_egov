                ...
                <ul class="mt-3">
                    ...
                    <li class="mt-6"> 
                        <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                            ...
                            <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">ADMIN PANEL</span>
                        </h3>
                        <ul class="mt-3">
                            <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 @if(Request::segment(1) === 'penduduk'){{ 'bg-linear-to-r from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif">
                                <a href="{{ route('penduduk.index') }}" class="flex items-center text-gray-800 dark:text-gray-100 truncate transition {{ Request::segment(1) === 'penduduk' ? 'text-violet-500 hover:text-violet-500 dark:text-violet-400' : 'hover:text-gray-900 dark:hover:text-white' }}">
                                    <svg class="shrink-0 w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h-4a2 2 0 01-2-2v-3H9V7a2 2 0 012-2h6a2 2 0 012 2v10a2 2 0 01-2 2zM9 13H5m0-4h4m-4 8h10"></path>
                                    </svg>
                                    <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Kelola Data Penduduk</span>
                                </a>
                            </li>
                            <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 @if(Request::segment(1) === 'antrian'){{ 'bg-linear-to-r from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif">
                                    <svg class="shrink-0 w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-2-3H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2z"></path>
                                    </svg>
                                    <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Daftar Antrian Surat</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="shrink-0 fill-current @if(in_array(Request::segment(1), ['ecommerce'])){{ 'text-violet-500' }}@else{{ 'text-gray-400 dark:text-gray-500' }}@endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                        <path d="M9 6.855A3.502 3.502 0 0 0 8 0a3.5 3.5 0 0 0-1 6.855v1.656L5.534 9.65a3.5 3.5 0 1 0 1.229 1.578L8 10.267l1.238.962a3.5 3.5 0 1 0 1.229-1.578L9 8.511V6.855ZM6.5 3.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM6.5 3.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM6.5 3.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Zm4.803 8.095c.005-.005.01-.01.013-.016l.012-.016a1.5 1.5 0 1 1-.025.032ZM3.5 11c.474 0 .897.22 1.171.563l.013.016.013.017A1.5 1.5 0 1 1 3.5 11Z" />
                                    </svg>
